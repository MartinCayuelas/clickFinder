...
object Predicter {
  ...
  def main(args: Array[String]) {
    ...
    val featuresCols = Array("appOrSite", "timestamp", "size", "os", "bidFloor", "type", "IAB1", "IAB2", "IAB3", "IAB4", "IAB5", "IAB6", "IAB7", "IAB8", "IAB9", "IAB10", "IAB11", "IAB12", "IAB13", "IAB14", "IAB15", "IAB16", "IAB17", "IAB18", "IAB19", "IAB20", "IAB21", "IAB22", "IAB23", "IAB24", "IAB25", "IAB26")
